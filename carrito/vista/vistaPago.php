    ...
    <div class="container text-center">
      ...
      <div class="container border-start border-end border-dark border-2 mt-2 text-center p-2 ">
        <div class="border border-dark p-0">
          <?php
          if ($row->ID_Estado == 6) {
            echo "<h4 style='background-color:#F12222;'>$row->Estado</h4>";
          } else if ($row->ID_Estado == 5) {
            echo "<h4 style='background-color:yellow;'>$row->Estado</h4>";
          } else if ($row->ID_Estado == 4) {
            echo "<h4 style='background-color:#85F130;'>$row->Estado</h4>";
          } else if ($row->ID_Estado == 3) {
            echo "<h4 style='background-color:#85C1E9;'>$row->Estado</h4>";
          } else if ($row->ID_Estado == 2) {
            echo "<h4 style='background-color:#D9FF6B;'>$row->Estado</h4>";
          } else {
            echo "<h4 style='background-color:#E5E7E9;'>$row->Estado</h4>";
          }
          ?>
        </div>
      </div>
