...
function updateEstado(idEstado) {
    ...
    xmlhttp.open("POST", "http://localhost/php/admin/pedido/modelo/cambiarEstados.php", true);
...
function loadPedidos() {
    ...
    xmlhttp.open("GET", "http://localhost/php/admin/pedido/modelo/getPedidos.php?pagina=" + pagina, true);
    xmlhttp.send();
}
function loadPedidoPorID() {
    var xmlhttp = new XMLHttpRequest();
    xmlhttp.onreadystatechange = procesarPedidoxID;
    xmlhttp.open("GET", "http://localhost/php/admin/pedido/modelo/getPedidoPorID.php?idPedido=" + idPedido, true);
    xmlhttp.send();
}