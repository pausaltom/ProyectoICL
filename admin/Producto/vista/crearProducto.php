...
<body>
    ...
    <div class="container border border-dark w-100 h-100 p-4 my-5">
        ...
        <div class="container my-2 d-flex color-White-6 rounded-4">
            <form action="../modelo/crearProducto.php" id="formularioProducto" method="POST">
                <div class="container my-2 p-0 d-flex color-White-6 rounded-4">
                    <div class="container mx-2 ">
                    ...
                    <div class="container border-start border-dark mx-2">
                        ...
                        <select class="my-5 w-100" name="categoriaProducto" id="categoriaProducto" required>
                        </select>
                    </div>
                    <div>
                    ...
                    <div class="container border-start border-dark mx-2">
                        <button class="btn btn-success my-5" type="button" id="btnEnviar">Crear Producto</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <script type="text/javascript" src="../controlador/crearProducto.js"></script>
